...
function Projects() {
    return (
        <div className="flex items-center min-h-lg p-10 space-x-4 flex-wrap justify-around space-y-4 w-full h-full bg-cover bg-center py-26 bg-[url(/background-5.png)] p-10">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-6">Projects</h2>
