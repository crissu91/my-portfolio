function Resume() {
    return (
        ...
        <section>
                ...
                <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">Northcoders - Leeds - May 2023 to Present </h4>
                <p className="mt-6 text-l leading-8 text-gray-700">
                    ...
                    <ul>
                        ...
                        Developed web applications using a range of technologies, including JavaScript, Node.js, Express.js, PostgreSQL, and React
                        </li>
                        <li className="flex gap-x-3">
                        <svg className="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        Collaborated with other developers using pair programming to produce high-quality code
                        </li>
                        <li className="flex gap-x-3">
                        <svg className="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        <path fillRule="evenodd" d="M5.5 17a4.5 4.5 0 01-1.44-8.765 4.5 4.5 0 018.302-3.046 3.5 3.5 0 014.504 4.272A4 4 0 0115 17H5.5zm3.75-2.75a.75.75 0 001.5 0V9.66l1.95 2.1a.75.75 0 101.1-1.02l-3.25-3.5a.75.75 0 00-1.1 0l-3.25 3.5a.75.75 0 101.1 1.02l1.95-2.1v4.59z" clipRule="evenodd" />
                        </svg>
                        Followed test-driven development practices to ensure high code quality and minimize errors in the software
                        </li>
                    </ul>
                    <p>Overall, my time at Northcoders has provided me with comprehensive training in both front-end and back-end web development technologies, including JavaScript, Jest TDD, HTML, CSS, React, Node.js, Express, PostgreSQL, and cloud deployment. Through practical projects, I have gained hands-on experience in developing robust backend projects using Node.js and Express, as well as designing and implementing functional front-end projects using React, showcasing my expertise in front-end development.

                </p>
            <h3 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Senior Payroll Administrator </h3>
            <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">Maria Mallaband Care Group - Leeds - September 2019 to May </h4>
            ...
            <h3 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Payroll Administrator</h3>
            <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">Mach Recruitment Ltd - Leeds - February 2017 to October 2017 </h4>
            ...
            <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">Garanti Bank - Bucharest,Romania - June 2012 to August 2012 </h4>
        ...
        <section>
                ...
                <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">Northcoders - Leeds - May 2023 to August 2023 </h4>
                <h3 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Payroll Processes</h3>
                <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">New Skills Academy - Leeds - January 2017 to March 2017 </h4>
                <h3 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">CIPD Human Resources Practice Level 3</h3>
                <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">University Centre at Wakefield College - Wakefield - September 2015 to July 2016 </h4>
                ...
                <h4 className="text-gray-500 dark:text-gray-200 pt-8 sm:pt-12 font-light">Bucharest University - Bucharest - October 2010 to June 2013 </h4>
